...
\section{Debugging tricks}
	\begin{itemize}
		\item \verb@signal(SIGSEGV, [](ll) { _Exit(0); });@ converts segfaults into Wrong Answers.
...
\section{Optimization tricks}
	...
	\subsection{Bit hacks}
		\begin{itemize}
			...
			\item \verb@for (ll x = m; x; ) { --x &= m; ... }@ loops over all subset masks of \texttt{m} (except \texttt{m} itself).
